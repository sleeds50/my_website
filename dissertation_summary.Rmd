...
<center>__Engagement at Work: Investigating the Relationships Between  
Age-Groups, Gender, Personality; and Trait Emotional Intelligence__
...
__Purpose:__ To add to and extend existing research of engagement at work with new findings regarding age-groups, gender, personality; and trait emotional intelligence (TEI). 

__Design:__ A cross-sectional correlation study with added mediator and moderator analyses. Exploratory analyses include two-tailed correlation, hierarchical multiple linear regression and additional mediator analysis. 

<br>

A simple research question reflects the title:

  - *What is the relationship between age-groups, gender, personality, TEI and;
    engagement at work?*
...
<center>**Figure 1.** *Participant Numbers by Age-group and Gender*</center>

<br>

```{r , group, echo=FALSE, out.width="80%"}
...
<center>**Figure 2.** *H1 Correlations between Engagement and Personality*</center>

``` {r h1_plot, echo=FALSE, out.width="80%", fig.cap="_Note:_ 1= Engagement, 2= Extraversion, 3=Agreeableness, 4= Conscientiousness, <br>5= Emotional Stability, 6= Openness to Experience. _N_= 88; * _p_ < .05; ** _p_ < .01."}
knitr::include_graphics("./images/H1_wide.png")
```

<br>

<u>__Exploratory results__</u>
...
($`r wordcountaddin::word_count()`$ words)
