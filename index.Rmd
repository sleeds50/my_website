...
Thanks to *Andreas Handel* for the [build tutorial](https://www.andreashandel.com/post/github-website/); who adds:

> *"I also have a discussion of R Markdown and reproducibility [on one of my 
course pages](https://andreashandel.github.io/MADAcourse/1e_ToolsforReproducibility.html). 
You'll find additional links to potentially useful R Markdown (and Github) resources there".*
...
__Dissertation:__ [Quantitative design] A cross-sectional correlational study, with added mediator and moderator analyses.  
...
__Title:__ _"Volunteering and identity: a discursive approach to how volunteers see themselves and are seen by others"._
...
__Courses:__ R-programming; The data scientists toolbox; Getting and cleaning data; Exploratory data analysis; Reproducible research.
