...
Links to various Social & Occupational psychology projects I've conducted, or been involved with; and items of interest regarding R-programming (my own or things I've found).
...
This website is a collection of regular (R)Markdown documents, so you can use all the usual formatting. If you are new to R Markdown, you can learn more about it [on the R Markdown website](https://rmarkdown.rstudio.com/).
...
**Dissertation title:** *"Engagement at work: investigating the relationships between age groups, gender, personality; and trait EI."*
